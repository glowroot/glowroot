...
import org.glowroot.agent.core.DataDirLocking;
import org.glowroot.agent.core.LoggingInit;
import org.glowroot.agent.core.ViewerAgentModule;
    ...
    private static class PlatformMBeanServerLifecycleImpl implements PlatformMBeanServerLifecycle {
        ...
        public void addInitListener(final InitListener listener) {
            lazyPlatformMBeanServer.addInitListener(
                    new org.glowroot.agent.core.util.LazyPlatformMBeanServer.InitListener() {
                        @Override
