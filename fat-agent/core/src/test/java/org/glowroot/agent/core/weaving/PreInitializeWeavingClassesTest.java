...
public class PreInitializeWeavingClassesTest {
    ...
    public void shouldCheckHardcodedListAgainstReality() throws IOException {
        ...
        // go unseen
        globalCollector.registerClass("org/glowroot/agent/core/impl/WeavingTimerServiceImpl");
        globalCollector.registerClass("org/glowroot/agent/core/weaving/ImmutableAdvice");
        ...
        globalCollector.processMethodFailIfNotFound(
                ReferencedMethod.from("org/glowroot/agent/core/weaving/AnalyzedWorld", "<init>",
                        "(L" + getGuavaSupplierInternalName() + ";Ljava/util/List;Ljava/util/List;"
                                + "Lorg/glowroot/agent/core/weaving/ExtraBootResourceFinder;)V"));
        // "call" WeavingClassFileTransformer constructor
        globalCollector.processMethodFailIfNotFound(ReferencedMethod.from(
                "org/glowroot/agent/core/weaving/WeavingClassFileTransformer", "<init>",
                "(Ljava/util/List;Ljava/util/List;L" + getGuavaSupplierInternalName() + ";"
                        + "Lorg/glowroot/agent/core/weaving/AnalyzedWorld;"
                        + "Lorg/glowroot/agent/core/weaving/WeavingTimerService;Z)V"));
        // "call" WeavingClassFileTransformer.transform()
        globalCollector.processMethodFailIfNotFound(
                ReferencedMethod.from("org/glowroot/agent/core/weaving/WeavingClassFileTransformer",
