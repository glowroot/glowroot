...
import org.glowroot.agent.core.weaving.GlobalCollector;
import org.glowroot.agent.core.weaving.ReferencedMethod;
import org.glowroot.agent.fat.PreInitializeStorageShutdownClasses;
...
public class PreInitializeStorageShutdownClassesTest {
    ...
    public void shouldCheckHardcodedListAgainstReality() throws IOException {
        ...
        globalCollector.processMethodFailIfNotFound(ReferencedMethod.from(
                "org/glowroot/storage/simplerepo/util/ConnectionPool$ShutdownHookThread", "run",
                "()V"));
        globalCollector.processMethodFailIfNotFound(ReferencedMethod.from(
                "org/glowroot/storage/simplerepo/util/CappedDatabase$ShutdownHookThread", "run",
                "()V"));
