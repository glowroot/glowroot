...
- Versions stay on the latest **published** release (`0.14.8-beta.4` today); bump Central image + `GLOWROOT_VERSION` together when a newer GitHub release / Docker Hub tag exists.
- Compose waits for Cassandra/Rabbit health and Central `GET /health` before starting the sample app.
