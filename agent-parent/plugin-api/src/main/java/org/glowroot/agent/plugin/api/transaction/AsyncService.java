...
public interface AsyncService {
    ...
    // syncTimerName only tracks portion of current thread time spent waiting on this async work
    // and will appear in current thread timer tree
    //
    // asyncTimerName will be root async timer with nothing under it
