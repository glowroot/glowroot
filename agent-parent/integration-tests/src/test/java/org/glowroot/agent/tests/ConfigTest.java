...
import org.glowroot.agent.it.harness.config.AlertConfig;
import org.glowroot.agent.it.harness.config.GaugeConfig;
import org.glowroot.agent.it.harness.config.GaugeConfig.MBeanAttribute;
...
import org.glowroot.agent.it.harness.config.SmtpConfig;
import org.glowroot.agent.it.harness.config.StorageConfig;
...
import org.glowroot.agent.it.harness.config.UserInterfaceConfig.AnonymousAccess;
