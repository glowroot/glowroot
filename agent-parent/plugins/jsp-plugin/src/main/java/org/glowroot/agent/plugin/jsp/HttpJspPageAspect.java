...
public class HttpJspPageAspect {
    ...
    @Shim("javax.servlet.jsp.HttpJspPage")
    ...
    public static class HttpJspPageAdvice {
        ...
        @OnBefore
        public static TraceEntry onBefore(@BindReceiver HttpJspPage httpJspPage, @BindParameter @Nullable Object req) {
            ...
            return transactionService.startTraceEntry(
                    MessageSupplier.from("jsp render {}",
                            filename), timerName);
        }
