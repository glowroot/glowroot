...
public class ThreadSafeCollectionOfTenBenchmark {
    ...
    public static void main(String[] args) {
        ...
        runner.run(SynchronizedArrayBenchmark.class.getName());
        runner.run(SynchronizedArrayWithBadCapacityBenchmark.class.getName());
        runner.run(ConcurrentLinkedQueueBenchmark.class.getName());
        runner.run(CopyOnWriteArrayListBenchmark.class.getName());
    }
