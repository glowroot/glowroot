...
(function ($) {
    function init(plot) {
        ...
        function onMouseDown(e) {
            ...
            // disable hovering during selection
            savedHoverable = plot.getOptions().grid.hoverable;
        ...
        function onMouseUp(e) {
            ...
            // revert hoverable flag after selection
            plot.getOptions().grid.hoverable = savedHoverable;
            updateSelection(e);
        ...
        $(document).keyup(function (e) {
            if (selection.active && e.keyCode === 27) { // esc key
                clearSelection(true);
                selection.active = false;
                // revert hoverable flag after selection
                plot.getOptions().grid.hoverable = savedHoverable;
