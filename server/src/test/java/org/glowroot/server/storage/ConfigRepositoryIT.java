...
public class ConfigRepositoryIT {
    ...
    public static void setUp() throws Exception {
        ...
        configRepository = new ConfigRepositoryImpl(serverConfigDao, agentDao, userDao, roleDao);
    }
    ...
    @Test
    public void shouldUpdateServerStorageConfig() throws Exception {
        // given
        ServerStorageConfig config = configRepository.getServerStorageConfig();
        ServerStorageConfig updatedConfig = ImmutableServerStorageConfig.builder()
        ...
        // when
        configRepository.updateServerStorageConfig(updatedConfig, config.version());
        config = configRepository.getServerStorageConfig();
