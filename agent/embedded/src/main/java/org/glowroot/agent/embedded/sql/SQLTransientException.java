...
// this class serves as the relocation target for java.sql.SQLTransientException so that
// H2's JdbcSQLTransientException (which extends java.sql.SQLTransientException) is
