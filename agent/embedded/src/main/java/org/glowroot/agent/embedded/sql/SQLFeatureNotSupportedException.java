...
// this class serves as the relocation target for java.sql.SQLFeatureNotSupportedException so that
// H2's JdbcSQLFeatureNotSupportedException (which extends java.sql.SQLFeatureNotSupportedException)
// is assignable to org.glowroot.agent.embedded.sql.SQLException after shading
