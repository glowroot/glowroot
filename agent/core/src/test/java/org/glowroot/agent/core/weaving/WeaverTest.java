...
import org.glowroot.agent.core.weaving.AbstractMisc.ExtendsAbstractMisc;
import org.glowroot.agent.core.weaving.AbstractNotMisc.ExtendsAbstractNotMisc;
import org.glowroot.agent.core.weaving.SomeAspect.BasicAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BasicLowPriorityAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BasicMiscAllConstructorAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BasicMiscConstructorAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BasicWithInnerClassAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BasicWithInnerClassArgAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindAutoboxedReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindClassMetaAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindMethodMetaAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindMethodMetaArrayAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindMethodMetaReturnArrayAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindMethodNameAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindOptionalPrimitiveReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindOptionalReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindOptionalVoidReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindParameterAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindParameterArrayAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindPrimitiveBooleanTravelerAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindPrimitiveReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindPrimitiveTravelerAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindReceiverAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindThrowableAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BindTravelerAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.BrokenAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.ChangeReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.CircularClassDependencyAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.ClassNamePatternAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.FinalMethodAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.HasString;
import org.glowroot.agent.core.weaving.SomeAspect.HasStringClassMixin;
import org.glowroot.agent.core.weaving.SomeAspect.HasStringInterfaceMixin;
import org.glowroot.agent.core.weaving.SomeAspect.HasStringMultipleMixin;
import org.glowroot.agent.core.weaving.SomeAspect.InnerMethodAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.InterfaceAppearsTwiceInHierarchyAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.MatchingPublicNonStaticAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.MethodParametersBadDotDotAdvice1;
import org.glowroot.agent.core.weaving.SomeAspect.MethodParametersDotDotAdvice1;
import org.glowroot.agent.core.weaving.SomeAspect.MethodParametersDotDotAdvice2;
import org.glowroot.agent.core.weaving.SomeAspect.MethodParametersDotDotAdvice3;
import org.glowroot.agent.core.weaving.SomeAspect.MethodReturnCharSequenceAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.MethodReturnStringAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.MethodReturnVoidAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.MultipleMethodsAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.NonMatchingMethodReturnAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.NonMatchingMethodReturnAdvice2;
import org.glowroot.agent.core.weaving.SomeAspect.NonMatchingStaticAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.NotNestingAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.NotNestingWithNoIsEnabledAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.PrimitiveAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.PrimitiveWithAutoboxAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.PrimitiveWithWildcardAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.Shimmy;
import org.glowroot.agent.core.weaving.SomeAspect.StaticAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.SuperBasicAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.TargetedAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.TestBytecodeWithStackFramesAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.TestBytecodeWithStackFramesAdvice2;
import org.glowroot.agent.core.weaving.SomeAspect.TestBytecodeWithStackFramesAdvice3;
import org.glowroot.agent.core.weaving.SomeAspect.TestBytecodeWithStackFramesAdvice4;
import org.glowroot.agent.core.weaving.SomeAspect.TestBytecodeWithStackFramesAdvice5;
import org.glowroot.agent.core.weaving.SomeAspect.TestBytecodeWithStackFramesAdvice6;
import org.glowroot.agent.core.weaving.SomeAspect.TestClassMeta;
import org.glowroot.agent.core.weaving.SomeAspect.TestMethodMeta;
import org.glowroot.agent.core.weaving.SomeAspect.TestTroublesomeBytecodeAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.ThrowInOnBeforeAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.ThrowableToStringAdvice;
import org.glowroot.agent.core.weaving.SomeAspect.WildMethodAdvice;
import org.glowroot.agent.core.weaving.SomeAspectThreadLocals.IntegerThreadLocal;
import org.glowroot.agent.core.weaving.WeavingTimerService.WeavingTimer;
import org.glowroot.agent.core.weaving.other.ArrayMisc;
...
public class WeaverTest {
    ...
    public void shouldBindMethodMetaArrays() throws Exception {
        ...
        Class<?> somethingPrivateClass =
                Class.forName("org.glowroot.agent.core.weaving.other.ArrayMisc$SomethingPrivate");
