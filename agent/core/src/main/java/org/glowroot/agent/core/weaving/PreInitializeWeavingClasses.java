...
public class PreInitializeWeavingClasses {
    ...
    private static List<String> getGlowrootUsedTypes() {
        List<String> types = Lists.newArrayList();
        types.add("org.glowroot.agent.core.impl.TransactionRegistry");
        types.add("org.glowroot.agent.core.impl.WeavingTimerServiceImpl");
        types.add("org.glowroot.agent.core.impl.WeavingTimerServiceImpl$2");
        types.add("org.glowroot.agent.core.impl.WeavingTimerServiceImpl$NopWeavingTimer");
        types.add("org.glowroot.agent.core.model.NestedTimerMap");
        types.add("org.glowroot.agent.core.model.NestedTimerMap$Entry");
        types.add("org.glowroot.agent.core.model.TimerImpl");
        types.add("org.glowroot.agent.core.model.TimerNameImpl");
        types.add("org.glowroot.agent.core.model.Transaction");
        ...
        types.add("org.glowroot.agent.core.util.Reflections");
        types.add("org.glowroot.agent.core.util.Tickers");
        types.add("org.glowroot.agent.core.util.Tickers$DummyTicker");
        types.add("org.glowroot.agent.core.weaving.Advice");
        types.add("org.glowroot.agent.core.weaving.Advice$AdviceOrdering");
        types.add("org.glowroot.agent.core.weaving.Advice$AdviceParameter");
        types.add("org.glowroot.agent.core.weaving.AdviceFlowOuterHolder");
        types.add("org.glowroot.agent.core.weaving.AdviceFlowOuterHolder$1");
        types.add("org.glowroot.agent.core.weaving.AdviceFlowOuterHolder$AdviceFlowHolder");
        types.add("org.glowroot.agent.core.weaving.AdviceMatcher");
        types.add("org.glowroot.agent.core.weaving.AnalyzedClass");
        types.add("org.glowroot.agent.core.weaving.AnalyzedMethod");
        types.add("org.glowroot.agent.core.weaving.AnalyzedWorld");
        types.add("org.glowroot.agent.core.weaving.AnalyzedWorld$1");
        types.add("org.glowroot.agent.core.weaving.AnalyzedWorld$ParseContext");
        types.add("org.glowroot.agent.core.weaving.AnalyzingClassVisitor");
        types.add("org.glowroot.agent.core.weaving.AnalyzingClassVisitor$ShortCircuitException");
        types.add("org.glowroot.agent.core.weaving.BootstrapMetaHolders");
        types.add("org.glowroot.agent.core.weaving.BootstrapMetaHolders$ClassMetaHolder");
        types.add("org.glowroot.agent.core.weaving.BootstrapMetaHolders$MethodMetaHolder");
        types.add("org.glowroot.agent.core.weaving.ClassLoaders");
        types.add("org.glowroot.agent.core.weaving.ClassNames");
        types.add("org.glowroot.agent.core.weaving.ExtraBootResourceFinder");
        types.add("org.glowroot.agent.core.weaving.GeneratedBytecodeUtil");
        types.add("org.glowroot.agent.core.weaving.ImmutableAdvice");
        types.add("org.glowroot.agent.core.weaving.ImmutableAdviceMatcher");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedClass");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedClass$Builder");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedMethod");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedMethod$Builder");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedMethodKey");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedMethodKey$Builder");
        types.add("org.glowroot.agent.core.weaving.ImmutableCatchHandler");
        types.add("org.glowroot.agent.core.weaving.ImmutableMethodMetaGroup");
        types.add("org.glowroot.agent.core.weaving.ImmutableMethodMetaGroup$Builder");
        types.add("org.glowroot.agent.core.weaving.ImmutableParseContext");
        types.add("org.glowroot.agent.core.weaving.MixinType");
        types.add("org.glowroot.agent.core.weaving.ParameterKind");
        types.add("org.glowroot.agent.core.weaving.PointcutClassVisitor");
        types.add("org.glowroot.agent.core.weaving.ShimType");
        types.add("org.glowroot.agent.core.weaving.Weaver");
        types.add("org.glowroot.agent.core.weaving.Weaver$ComputeFramesClassWriter");
        types.add("org.glowroot.agent.core.weaving.Weaver$JSRInlinerClassVisitor");
        types.add("org.glowroot.agent.core.weaving.WeavingClassFileTransformer");
        types.add("org.glowroot.agent.core.weaving.WeavingClassVisitor");
        types.add("org.glowroot.agent.core.weaving.WeavingClassVisitor$AnalyzedMethodKey");
        types.add("org.glowroot.agent.core.weaving.WeavingClassVisitor$InitMixins");
        types.add("org.glowroot.agent.core.weaving.WeavingClassVisitor$MethodMetaGroup");
        types.add(
                "org.glowroot.agent.core.weaving.WeavingClassVisitor$PointcutClassFoundException");
        types.add("org.glowroot.agent.core.weaving.WeavingMethodVisitor");
        types.add("org.glowroot.agent.core.weaving.WeavingMethodVisitor$CatchHandler");
        types.add("org.glowroot.agent.core.weaving.WeavingTimerService");
        types.add("org.glowroot.agent.core.weaving.WeavingTimerService$WeavingTimer");
        return types;
    }
    ...
    static List<String> maybeUsedTypes() {
        ...
        types.add("org.glowroot.agent.core.model.NestedTimerMap$1");
        types.add("org.glowroot.agent.core.util.Tickers$1");
        types.add("org.glowroot.agent.core.weaving.Advice$1");
        types.add("org.glowroot.agent.core.weaving.AnalyzedClass$1");
        types.add("org.glowroot.agent.core.weaving.AnalyzedMethod$1");
        types.add("org.glowroot.agent.core.weaving.AnalyzedMethodKey$1");
        types.add("org.glowroot.agent.core.weaving.BootstrapMetaHolders$1");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedClass$1");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedMethod$1");
        types.add("org.glowroot.agent.core.weaving.ImmutableAnalyzedMethodKey$1");
        types.add("org.glowroot.agent.core.weaving.ImmutableMethodMetaGroup$1");
        types.add("org.glowroot.agent.core.weaving.MethodMetaGroup$1");
        types.add("org.glowroot.agent.core.weaving.Weaver$1");
        types.add("org.glowroot.agent.core.weaving.WeavingClassVisitor$1");
        ...
        types.add("org.glowroot.agent.core.weaving.AdviceMatcher$1");
        types.add("org.glowroot.agent.core.weaving.WeavingMethodVisitor$1");
        // used when agent is shaded
        types.add("org.glowroot.agent.core.jul.Logger");
        types.add("org.glowroot.agent.core.jul.Level");
        return types;
    }
