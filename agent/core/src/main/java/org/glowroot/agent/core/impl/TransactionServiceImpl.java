...
import org.glowroot.agent.core.model.ErrorMessage;
import org.glowroot.agent.core.model.QueryData;
import org.glowroot.agent.core.model.QueryEntryBase;
import org.glowroot.agent.core.model.TimerImpl;
import org.glowroot.agent.core.model.TimerNameImpl;
import org.glowroot.agent.core.model.Transaction;
import org.glowroot.agent.core.model.Transaction.CompletionCallback;
import org.glowroot.agent.core.model.Transaction.OverrideSource;
...
public class TransactionServiceImpl implements TransactionService, ConfigListener {
    ...
    private void addErrorEntryInternal(ErrorMessage errorMessage) {
        ...
        if (transaction != null
            ...
            org.glowroot.agent.core.model.TraceEntryImpl entry =
    ...
    private class DummyTraceEntryOrQuery extends QueryEntryBase implements QueryEntry, Timer {
        ...
        private void endWithErrorInternal(ErrorMessage errorMessage) {
            ...
            if (transaction.getEntryCount() < 2 * maxTraceEntriesPerTransaction) {
                ...
                org.glowroot.agent.core.model.TraceEntryImpl entry = transaction.addEntry(startTick,
