...
import org.glowroot.agent.core.weaving.Advice;
import org.glowroot.agent.core.weaving.AdviceBuilder;
import org.glowroot.agent.core.weaving.AdviceFlowOuterHolder;
import org.glowroot.agent.core.weaving.ClassLoaders.LazyDefinedClass;
import org.glowroot.agent.core.weaving.ImmutableLazyDefinedClass;
...
public class AdviceGenerator {
    ...
    private AdviceGenerator(InstrumentationConfig config, @Nullable String pluginId) {
        ...
        adviceInternalName = "org/glowroot/agent/core/advicegen/GeneratedAdvice" + uniqueNum;
        if (config.isTraceEntryOrGreater() || !config.transactionNameTemplate().isEmpty()
            ...
            methodMetaInternalName =
                    "org/glowroot/agent/core/advicegen/GeneratedMethodMeta" + uniqueNum;
        } else {
    ...
    private void addOnBeforeMethod(ClassWriter cw) {
        ...
        if (config.isTransaction()) {
            ...
            mv.visitMethodInsn(INVOKEVIRTUAL, methodMetaInternalName, "getTransactionNameTemplate",
                    "()Lorg/glowroot/agent/core/advicegen/MessageTemplate;", false);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 1);
            mv.visitVarInsn(ALOAD, 2);
            mv.visitMethodInsn(INVOKESTATIC,
                    "org/glowroot/agent/core/advicegen/GenericMessageSupplier",
                    "create",
                    "(Lorg/glowroot/agent/core/advicegen/MessageTemplate;"
                            + "Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)"
                            + "Lorg/glowroot/agent/core/advicegen/GenericMessageSupplier;",
                    false);
    ...
    private void addCodeForOptionalTraceAttributes(MethodVisitor mv) {
        ...
        if (!config.transactionNameTemplate().isEmpty() && !config.isTransaction()) {
            ...
            mv.visitMethodInsn(INVOKESTATIC,
                    "org/glowroot/agent/core/advicegen/GenericMessageSupplier",
                    "create",
                    "(Lorg/glowroot/agent/core/advicegen/MessageTemplate;Ljava/lang/Object;"
    ...
    private LazyDefinedClass generateMethodMetaClass(InstrumentationConfig config)
        ...
        cw.visitField(ACC_PRIVATE + ACC_FINAL, "messageTemplate",
                "Lorg/glowroot/agent/core/advicegen/MessageTemplate;", null, null)
                .visitEnd();
    ...
    private void generateMethodMetaConstructor(ClassWriter cw) {
        ...
        if (config.isTraceEntryOrGreater()) {
            ...
            mv.visitVarInsn(ALOAD, 3);
            mv.visitMethodInsn(INVOKESTATIC,
                    "org/glowroot/agent/core/advicegen/MessageTemplate",
                    "create",
