...
public class PreInitializeWeavingClasses {
    ...
    private static List<String> getGlowrootUsedTypes() {
        ...
        types.add("org.glowroot.agent.weaving.GenericClassVisitor");
        types.add("org.glowroot.agent.weaving.GenericClassVisitor$GenericClassInfo");
        types.add("org.glowroot.agent.weaving.GenericClassVisitor$GenericClassInfo$1");
        types.add("org.glowroot.agent.weaving.GenericClassVisitor$GenericTypeInfo");
        types.add("org.glowroot.agent.weaving.GenericClassVisitor$GenericTypeVisitor");
        types.add("org.glowroot.agent.weaving.GenericClassVisitor$TypeParameterInfo");
        types.add("org.glowroot.agent.weaving.GenericTypeResolver");
        types.add("org.glowroot.agent.weaving.MethodDescriptorParser");
        types.add("org.glowroot.agent.weaving.MethodDescriptorParser$TypeParseResult");
        ...
        types.add("org.glowroot.agent.weaving.ImmutableGenericClassInfo");
        types.add("org.glowroot.agent.weaving.ImmutableGenericClassInfo$1");
        types.add("org.glowroot.agent.weaving.ImmutableGenericClassInfo$Builder");
        types.add("org.glowroot.agent.weaving.ImmutableGenericTypeInfo");
        types.add("org.glowroot.agent.weaving.ImmutableGenericTypeInfo$1");
        types.add("org.glowroot.agent.weaving.ImmutableGenericTypeInfo$Builder");
        types.add("org.glowroot.agent.weaving.ImmutableTypeParameterInfo");
        types.add("org.glowroot.agent.weaving.ImmutableTypeParameterInfo$1");
        types.add("org.glowroot.agent.weaving.ImmutableTypeParameterInfo$Builder");
