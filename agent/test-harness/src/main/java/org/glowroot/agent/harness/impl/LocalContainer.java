...
import org.glowroot.agent.core.AgentModule;
import org.glowroot.agent.core.DataDirLocking.BaseDirLockedException;
import org.glowroot.agent.core.MainEntryPoint;
import org.glowroot.agent.core.impl.AdviceCache;
import org.glowroot.agent.core.util.SpyingLogbackFilter;
import org.glowroot.agent.core.util.SpyingLogbackFilter.MessageCount;
import org.glowroot.agent.core.weaving.Advice;
import org.glowroot.agent.core.weaving.IsolatedWeavingClassLoader;
...
import org.glowroot.agent.harness.TempDirs;
import org.glowroot.agent.harness.admin.AdminService;
import org.glowroot.agent.harness.aggregate.AggregateService;
import org.glowroot.agent.harness.common.HttpClient;
import org.glowroot.agent.harness.config.ConfigService;
import org.glowroot.agent.harness.config.ConfigService.GetUiPortCommand;
import org.glowroot.agent.harness.trace.TraceService;
...
public class LocalContainer implements Container {
    ...
    public LocalContainer(@Nullable File baseDir, boolean useFileDb, int port, boolean shared,
        ...
        List<String> excludePackages = ImmutableList.of(
                "org.glowroot.common",
                "org.glowroot.wire.api",
                "org.glowroot.agent.api",
                "org.glowroot.agent.plugin.api",
                "org.glowroot.agent.core",
                "org.glowroot.agent.shaded",
                "com.google.common");
