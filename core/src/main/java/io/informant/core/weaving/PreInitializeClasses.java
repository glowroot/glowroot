...
class PreInitializeClasses {
    ...
    // * io.informant.shaded.slf4j.spi.LoggerFactoryBinder
    ...
    static ImmutableList<String> usedTypes() {
        ...
        types.add("io.informant.core.log.Level");
        ...
        types.add("io.informant.core.weaving.ParsedType");
        types.add("io.informant.core.weaving.ParsedType$Builder");
        types.add("io.informant.core.weaving.ParsedTypeCache");
        ...
        types.add("io.informant.core.weaving.WeavingClassVisitor");
        types.add("io.informant.core.weaving.WeavingClassVisitor$InitMixins");
        types.add("io.informant.core.weaving.WeavingClassVisitor$InitThreadLocals");
    ...
    static ImmutableList<String> maybeUsedTypes() {
        ...
        types.add("io.informant.api.LoggerFactory$1");
        types.add("io.informant.core.log.LoggerFactoryImpl$1");
        types.add("io.informant.core.weaving.ParsedType$1");
        ...
        types.add("io.informant.core.weaving.AdviceMatcher$1");
        return types.build();
    }
