...
class PreInitializeStorageShutdownClasses {
    ...
    private static List<String> getGlowrootUsedTypes() {
        List<String> types = Lists.newArrayList();
        types.add("org.glowroot.local.util.CappedDatabase");
        types.add("org.glowroot.local.util.CappedDatabase$ShutdownHookThread");
        types.add("org.glowroot.local.util.CappedDatabaseOutputStream");
        types.add("org.glowroot.local.util.DataSource");
        types.add("org.glowroot.local.util.DataSource$1");
        types.add("org.glowroot.local.util.DataSource$ShutdownHookThread");
        return types;
    }
