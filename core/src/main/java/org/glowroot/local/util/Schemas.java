...
public class Schemas {
    ...
    public static void syncTable(@Untainted String tableName, List<Column> columns,
    ...
    public static void syncIndexes(@Untainted String tableName, ImmutableList<Index> indexes,
            Connection connection) throws SQLException {
    ...
    public static boolean columnExists(String tableName, String columnName, Connection connection)
            throws SQLException {
    ...
    public static ImmutableList<Column> getColumns(String tableName, Connection connection)
            throws SQLException {
