...
class GlowrootServiceImpl implements GlowrootService {
    ...
    public void setTransactionError(@Nullable Throwable t) {
        ...
        Transaction transaction = transactionRegistry.getCurrentTransaction();
        if (transaction != null) {
            transaction.setError(ErrorMessageBase.from(t), OverrideSource.USER_API);
        }
    }
    ...
    public void setTransactionError(@Nullable String message) {
        ...
        Transaction transaction = transactionRegistry.getCurrentTransaction();
        if (transaction != null) {
            transaction.setError(ErrorMessageBase.from(message), OverrideSource.USER_API);
        }
    }
    ...
    public void setTransactionError(@Nullable String message, @Nullable Throwable t) {
        ...
        Transaction transaction = transactionRegistry.getCurrentTransaction();
        if (transaction != null) {
            transaction.setError(ErrorMessageBase.from(message, t), OverrideSource.USER_API);
        }
    }
