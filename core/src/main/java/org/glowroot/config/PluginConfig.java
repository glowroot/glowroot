...
public class PluginConfig {
    ...
    static final Ordering<PluginConfig> orderingByName = new Ordering<PluginConfig>() {
        ...
        public int compare(@Nullable PluginConfig left, @Nullable PluginConfig right) {
            checkNotNull(left);
            checkNotNull(right);
            return left.pluginDescriptor.getId().compareToIgnoreCase(
                    right.pluginDescriptor.getId());
        }
    };
    ...
    public static class Builder {
        ...
        private String buildVersion() {
            ...
            for (Map.Entry<String, Boolean> property : booleanProperties.entrySet()) {
                String name = property.getKey();
            ...
            for (Map.Entry<String, Optional<Double>> property : doubleProperties.entrySet()) {
                String name = property.getKey();
