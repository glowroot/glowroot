...
class PreInitializeStorageShutdownClasses {
    ...
    private static List<String> getGlowrootUsedTypes() {
        List<String> types = Lists.newArrayList();
        types.add("org.glowroot.server.simplerepo.util.CappedDatabase");
        types.add("org.glowroot.server.simplerepo.util.CappedDatabase$ShutdownHookThread");
        types.add("org.glowroot.server.simplerepo.util.CappedDatabaseOutputStream");
        types.add("org.glowroot.server.simplerepo.util.DataSource");
        types.add("org.glowroot.server.simplerepo.util.DataSource$1");
        types.add("org.glowroot.server.simplerepo.util.DataSource$ShutdownHookThread");
        return types;
    }
    ...
    private static List<String> getH2UsedTypes() {
        ...
        types.add("org.h2.engine.DbSettings");
        ...
        types.add("org.h2.store.LobStorageFrontend");
        types.add("org.h2.store.LobStorageInterface");
        types.add("org.h2.store.LobStorageRemoteInputStream");
        types.add("org.h2.store.fs.FileBase");
        types.add("org.h2.store.fs.FileChannelInputStream");
        types.add("org.h2.store.fs.FileChannelOutputStream");
        types.add("org.h2.store.fs.FilePath");
        types.add("org.h2.store.fs.FilePathEncrypt");
        types.add("org.h2.store.fs.FilePathEncrypt$FileEncrypt");
        types.add("org.h2.store.fs.FilePathEncrypt$XTS");
