...
class PreInitializeClasses {
    ...
    static ImmutableList<String> usedTypes() {
        ...
        types.add("org.informantproject.core.LoggerFactoryImpl");
        types.add("org.informantproject.core.LoggerFactoryImpl$LoggerImpl");
    ...
    static ImmutableList<String> maybeUsedTypes() {
        ...
        types.add("org.informantproject.core.LoggerFactoryImpl$1");
