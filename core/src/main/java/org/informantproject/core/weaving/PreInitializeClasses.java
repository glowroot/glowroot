...
class PreInitializeClasses {
    ...
    static ImmutableList<String> usedTypes() {
        ...
        types.add("com.google.common.base.AbstractIterator");
        types.add("com.google.common.base.AbstractIterator$1");
        types.add("com.google.common.base.AbstractIterator$State");
        ...
        types.add("com.google.common.base.Optional$1");
        types.add("com.google.common.base.Optional$1$1");
        types.add("com.google.common.base.Optional$Absent");
        types.add("com.google.common.base.Optional$Present");
        ...
        if (exists("org.informantproject.core.weaving.ParsedType$1")) {
        ...
        types.add("org.informantproject.core.weaving.ParsedTypeCache$1$1");
