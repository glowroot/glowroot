...
public class SomeAspect {
    ...
    @Pointcut(typeName = "io.informant.core.weaving.BasicMisc", methodName = "<init>")
    ...
    @Mixin(target = "io.informant.core.weaving.BasicMisc", mixin = HasString.class,
            mixinImpl = HasStringImpl.class)
    public static class ClassTargetedMixin {}

    @Mixin(target = "io.informant.core.weaving.Misc", mixin = HasString.class,
            mixinImpl = HasStringImpl.class)
    ...
    @Pointcut(typeName = "io.informant.core.weaving.StaticMisc", methodName = "executeStatic")
    ...
    @Pointcut(typeName = "io.informant.core.weaving.Mis*", methodName = "execute1")
    ...
    @Pointcut(typeName = "io.informant.core.weaving.PrimitiveMisc", methodName = "executePrimitive",
    ...
    @Pointcut(typeName = "io.informant.core.weaving.Misc3", methodName = "identity",
            methodArgs = { "io.informant.core.weaving.BasicMisc" })
