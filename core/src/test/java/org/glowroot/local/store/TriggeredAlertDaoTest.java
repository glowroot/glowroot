...
public class TriggeredAlertDaoTest {
    ...
    @Test
    public void shouldNotExist() throws SQLException {
        assertThat(triggeredAlertDao.exists("vvv1")).isFalse();
    }

    @Test
    public void shouldExistAfterInsert() throws SQLException {
    ...
    @Test
    public void shouldNotExistAfterDelete() throws SQLException {
