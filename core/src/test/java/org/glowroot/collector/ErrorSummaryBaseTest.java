...
public class ErrorSummaryBaseTest {
    ...
    public void shouldSortByErrorRate() {
        // given
        List<ErrorSummary> elements = buildElements();
        // when
        elements = ErrorSummaryBase.orderingByErrorRateDesc.sortedCopy(elements);
        // then
    ...
    public void shouldSortByErrorCount() {
        ...
        List<ErrorSummary> elements = buildElements();
        // when
        elements = ErrorSummaryBase.orderingByErrorCountDesc.sortedCopy(elements);
        // then
    ...
    private List<ErrorSummary> buildElements() {
        List<ErrorSummary> elements = Lists.newArrayList();
        elements.add(ErrorSummary.builder()
                .transactionName("a")
                .errorCount(2)
