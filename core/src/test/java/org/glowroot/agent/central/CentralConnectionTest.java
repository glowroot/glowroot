...
import org.glowroot.collector.spi.model.CollectorServiceGrpc;
import org.glowroot.collector.spi.model.CollectorServiceGrpc.CollectorService;
import org.glowroot.collector.spi.model.CollectorServiceOuterClass.AggregateMessage;
import org.glowroot.collector.spi.model.CollectorServiceOuterClass.Config;
import org.glowroot.collector.spi.model.CollectorServiceOuterClass.EmptyMessage;
import org.glowroot.collector.spi.model.CollectorServiceOuterClass.GaugeValueMessage;
import org.glowroot.collector.spi.model.CollectorServiceOuterClass.TraceMessage;
import org.glowroot.collector.spi.model.DownstreamServiceGrpc;
import org.glowroot.collector.spi.model.DownstreamServiceGrpc.DownstreamService;
import org.glowroot.collector.spi.model.DownstreamServiceOuterClass.ClientResponse;
import org.glowroot.collector.spi.model.DownstreamServiceOuterClass.MBeanTreeRequest;
...
public class CentralConnectionTest {
    ...
    private static class TestCollectorService implements CollectorService {
        ...
        @Override
        public void getConfig(EmptyMessage emptyMessage, StreamObserver<Config> responseObserver) {
            responseObserver.onNext(Config.newBuilder().build());
            responseObserver.onCompleted();
        }
    }
