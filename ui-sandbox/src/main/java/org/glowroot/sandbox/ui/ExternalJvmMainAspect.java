...
public class ExternalJvmMainAspect {
    ...
    @Pointcut(className = "org.glowroot.agent.harness.impl.JavaagentMain", methodName = "main",
    ...
    public static class MainAdvice {
        ...
        public static TraceEntry onBefore() {
            return transactionService.startTransaction("Sandbox", "javaagent container main",
                    MessageSupplier.from("org.glowroot.agent.harness.impl.JavaagentMain.main()"),
                    timerName);
        }
    ...
    @Pointcut(className = "org.glowroot.agent.harness.impl.JavaagentMain",
