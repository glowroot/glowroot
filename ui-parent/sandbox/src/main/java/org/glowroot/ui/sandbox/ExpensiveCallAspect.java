...
public class ExpensiveCallAspect {
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute0",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute1",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute2",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute3",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute4",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute5",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute6",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute7",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute8",
    ...
    @Pointcut(className = "org.glowroot.ui.sandbox.ExpensiveCall", methodName = "execute9",
