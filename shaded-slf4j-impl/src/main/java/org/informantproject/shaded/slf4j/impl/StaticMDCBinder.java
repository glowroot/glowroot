    ...
    public MDCAdapter getMDCA() {
        if (Configuration.useUnshadedSlf4j()) {
            ...
            return new ExtraShadedMDCAdapterAdapter(
                    org.informantproject.shaded.slf4jx.impl.StaticMDCBinder.SINGLETON.getMDCA());
        }
    }

    public String getMDCAdapterClassStr() {
        if (Configuration.useUnshadedSlf4j()) {
            return org.informantproject.shaded.slf4j.impl.StaticMDCBinder.SINGLETON
                    .getMDCAdapterClassStr();
        } else {
            return org.informantproject.shaded.slf4jx.impl.StaticMDCBinder.SINGLETON
                    .getMDCAdapterClassStr();
        }
    }
}
