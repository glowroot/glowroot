...
import org.informantproject.shaded.slf4j.spi.LoggerFactoryBinder;
...
public class StaticLoggerBinder implements LoggerFactoryBinder {
    ...
    public ILoggerFactory getLoggerFactory() {
        if (Configuration.useUnshadedSlf4j()) {
            ...
            return new ExtraShadedLoggerFactoryAdapter(
                    org.informantproject.shaded.slf4jx.impl.StaticLoggerBinder.getSingleton()
                            .getLoggerFactory());
        }
    }
    ...
    public String getLoggerFactoryClassStr() {
        if (Configuration.useUnshadedSlf4j()) {
            ...
            return org.informantproject.shaded.slf4jx.impl.StaticLoggerBinder.getSingleton()
