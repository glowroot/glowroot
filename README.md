Glowroot &nbsp;&nbsp; [![Join the chat at https://gitter.im/glowroot/glowroot](https://badges.gitter.im/glowroot/glowroot.svg)](https://gitter.im/glowroot/glowroot?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![Build Status](https://img.shields.io/travis/glowroot/glowroot.svg)](https://travis-ci.org/glowroot/glowroot)
=========

## Quick start

1. Download and unzip [glowroot-0.9.0-dist.zip](https://github.com/glowroot/glowroot/releases/download/v0.9.0/glowroot-0.9.0-dist.zip)
