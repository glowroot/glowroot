...
1. Download and unzip [glowroot-0.14.8-beta.4-dist.zip](https://github.com/glowroot/glowroot/releases/download/v0.14.8-beta.4/glowroot-0.14.8-beta.4-dist.zip)
